...
# # # def summarize_text(text, language="en_XX", max_length=300, min_length=30):
# # #     try:
# # #         inputs = tokenizer(
# # #             text,
# # #             return_tensors="pt",
...
# # # # Route for the homepage (accepts GET to render the form)
# # # @app.route('/', methods=['GET'])
# # # def index():
# # #     return render_template('index.html')

# # # # Route for summarization (accepts POST from the form)
...
# # nltk.download('punkt')
# # nltk.download('punkt_tab')  # Added to fix the punkt_tab error
...
# # # Load the model and tokenizer
# # model_name = "google/mt5-base"  # Upgraded from mt5-small for better performance
# # tokenizer = AutoTokenizer.from_pretrained(model_name)
# # model = AutoModelForSeq2SeqLM.from_pretrained(model_name)
# # model.eval()
...
# # def summarize_text(text, language="en_XX", max_length=500, min_length=50, num_beams=8, length_penalty=1.0):
# #     try:
...
# # Load the model and tokenizer
# model_name = "facebook/mbart-large-50"  # Switched to a better model for summarization
# tokenizer = AutoTokenizer.from_pretrained(model_name)
# model = AutoModelForSeq2SeqLM.from_pretrained(model_name)
# model.eval()
...
#     # Remove <extra_id_0> and similar tokens
...
# # Function to summarize text with improved parameters
# def summarize_text(text, language="en_XX", max_length=600, min_length=100, num_beams=10, length_penalty=1.2):
#     try:
#         # Preprocess the text to remove special tokens
...
#                 early_stopping=True,
#                 no_repeat_ngram_size=3,
#                 temperature=0.7,  # Added for better diversity
#                 top_p=0.9,  # Added for better quality
#             )
#             summary = tokenizer.decode(summary_ids[0], skip_special_tokens=True, clean_up_tokenization_spaces=True)
#             summaries.append(summary)
#         final_summary = " ".join(summaries)
#         # Post-process to remove any remaining special tokens
